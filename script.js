...
function updateCartUI() {
    ...
    for (const item in cartItems) {
        ...
        li.innerHTML = `${item} (x${cartItems[item]}) <button onclick="decreaseCartItem('${item}')">-</button> <button onclick="increaseCartItem('${item}')">+</button> <button onclick="removeFromCart('${item}')">Remove</button>`;
